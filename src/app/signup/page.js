...
const validationSchema = Yup.object({
    ...
    reenterPassword: Yup.string()
        .oneOf([Yup.ref('password'), null], 'Passwords must match').min(8)
...
export default function SignUp() {
    ...
    const handleSubmit = (values, { setSubmitting }) => {
        ...
        axios.post('http://13.50.187.28/api/v1/users/signup/', signupData)
            .then((response) => {
                                ...
                                <Grid container spacing={2}>
                                    <Grid item xs={12} sm={6}>
                                        <Field
                                            ...
                                            helperText={touched.firstName && errors.firstName ? <ErrorMessage name="firstName" /> : ''}
                                    ...
                                    <Grid item xs={12} sm={6}>
                                        <Field
                                            ...
                                            helperText={touched.lastName && errors.lastName ? <ErrorMessage name="lastName" /> : ''}
                                    ...
                                    <Grid item xs={12}>
                                        <Field
                                            ...
                                            helperText={touched.password && errors.password ? <ErrorMessage name="password" /> : ''}
                                    ...
                                    <Grid item xs={12}>
                                        <Field
                                            ...
                                            helperText={touched.reenterPassword && errors.reenterPassword ? <ErrorMessage name="reenterPassword" /> : ''}
                                    ...
                                    <Grid item xs={12}>
                                        <TextField
                                            ...
                                            helperText={touched.userType && errors.userType ? <ErrorMessage name="userType" /> : ''}
